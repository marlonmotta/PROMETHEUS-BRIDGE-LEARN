...
pub const PERSONAS_EMBEDDED: &[(&str, &str)] = &[
    // ── Fictional ────────────────────────────────────────────────────────
    ("aerith",          include_str!("../../../personas/fictional/aerith.json")),
    ("ainz-ooal-gown",  include_str!("../../../personas/fictional/ainz-ooal-gown.json")),
    ("albedo",          include_str!("../../../personas/fictional/albedo.json")),
    ("ash-ketchum",     include_str!("../../../personas/fictional/ash-ketchum.json")),
    ("bacon-hair",      include_str!("../../../personas/fictional/bacon-hair.json")),
    ("batman",          include_str!("../../../personas/fictional/batman.json")),
    ("breno",           include_str!("../../../personas/fictional/breno.json")),
    ("chris-redfield",  include_str!("../../../personas/fictional/chris-redfield.json")),
    ("claire-redfield", include_str!("../../../personas/fictional/claire-redfield.json")),
    ("cloud-strife",    include_str!("../../../personas/fictional/cloud-strife.json")),
    ("deadpool",        include_str!("../../../personas/fictional/deadpool.json")),
    ("deckard-cain",    include_str!("../../../personas/fictional/deckard-cain.json")),
    ("ezio-auditore",   include_str!("../../../personas/fictional/ezio-auditore.json")),
    ("gandalf",         include_str!("../../../personas/fictional/gandalf.json")),
    ("geralt",          include_str!("../../../personas/fictional/geralt.json")),
    ("gojo-satoru",     include_str!("../../../personas/fictional/gojo-satoru.json")),
    ("goku",            include_str!("../../../personas/fictional/goku.json")),
    ("iron-man",        include_str!("../../../personas/fictional/iron-man.json")),
    ...
    ("leon-kennedy",    include_str!("../../../personas/fictional/leon-kennedy.json")),
    ...
    ("mira",            include_str!("../../../personas/fictional/mira.json")),
    ("naofumi",         include_str!("../../../personas/fictional/naofumi.json")),
    ("naruto",          include_str!("../../../personas/fictional/naruto.json")),
    ("noob-roblox",     include_str!("../../../personas/fictional/noob-roblox.json")),
    ("pilar",           include_str!("../../../personas/fictional/pilar.json")),
    ("professor-x",     include_str!("../../../personas/fictional/professor-x.json")),
    ("raphtalia",       include_str!("../../../personas/fictional/raphtalia.json")),
    ("rebecca-chambers", include_str!("../../../personas/fictional/rebecca-chambers.json")),
    ("rumi",            include_str!("../../../personas/fictional/rumi.json")),
    ("samba",           include_str!("../../../personas/fictional/samba.json")),
    ...
    ("superman",        include_str!("../../../personas/fictional/superman.json")),
    ("tai-kamiya",      include_str!("../../../personas/fictional/tai-kamiya.json")),
    ("tanjiro",         include_str!("../../../personas/fictional/tanjiro.json")),
    ("thrall",          include_str!("../../../personas/fictional/thrall.json")),
    ("tifa",            include_str!("../../../personas/fictional/tifa.json")),
    ("tyrael",          include_str!("../../../personas/fictional/tyrael.json")),
    ("voljin",          include_str!("../../../personas/fictional/voljin.json")),
    ("wonder-woman",    include_str!("../../../personas/fictional/wonder-woman.json")),
    ("zoey",            include_str!("../../../personas/fictional/zoey.json")),
    // ── Real ─────────────────────────────────────────────────────────────
    ("ada-lovelace",       include_str!("../../../personas/real/ada-lovelace.json")),
    ("alan-turing",        include_str!("../../../personas/real/alan-turing.json")),
    ("albert-einstein",    include_str!("../../../personas/real/albert-einstein.json")),
    ("buckminster-fuller", include_str!("../../../personas/real/buckminster-fuller.json")),
    ("carl-sagan",         include_str!("../../../personas/real/carl-sagan.json")),
    ("charles-darwin",     include_str!("../../../personas/real/charles-darwin.json")),
    ("elon-musk",          include_str!("../../../personas/real/elon-musk.json")),
    ("galileu-galilei",    include_str!("../../../personas/real/galileu-galilei.json")),
    ("grace-hopper",       include_str!("../../../personas/real/grace-hopper.json")),
    ("isaac-newton",       include_str!("../../../personas/real/isaac-newton.json")),
    ("kevin-mitnick",      include_str!("../../../personas/real/kevin-mitnick.json")),
    ("leonardo-da-vinci",  include_str!("../../../personas/real/leonardo-da-vinci.json")),
    ("linus-torvalds",     include_str!("../../../personas/real/linus-torvalds.json")),
    ("marie-curie",        include_str!("../../../personas/real/marie-curie.json")),
    ("neil-degrasse-tyson", include_str!("../../../personas/real/neil-degrasse-tyson.json")),
    ("neymar-jr",          include_str!("../../../personas/real/neymar-jr.json")),
    ("nikola-tesla",       include_str!("../../../personas/real/nikola-tesla.json")),
    ("noam-chomsky",       include_str!("../../../personas/real/noam-chomsky.json")),
    ("richard-feynman",    include_str!("../../../personas/real/richard-feynman.json")),
    ("sergio-sacani",      include_str!("../../../personas/real/sergio-sacani.json")),
    ("stephen-hawking",    include_str!("../../../personas/real/stephen-hawking.json")),
    ("steve-jobs",         include_str!("../../../personas/real/steve-jobs.json")),
];
