# 📚 CATÁLOGO DE PERSONAS — P.R.O.M.E.T.H.E.U.S · B.R.I.D.G.E · L.E.A.R.N

> Lista de todas as personas **prontas para uso**.
> Cada persona é um arquivo `.json` em `personas/fictional/` ou `personas/real/`.

---

## 🔍 Como Usar

1. Encontre a persona ideal na tabela abaixo
2. Abra o arquivo `.json` correspondente
3. Copie o campo `prompts.system_prompt` e cole como System Prompt na sua IA
4. Use o campo `prompts.rewrite_instruction` seguido da prova/tarefa
5. Pronto — a IA reescreve o conteúdo no universo do aluno!

---

## 🎭 Personas Disponíveis

| # | Persona | Universo | Categoria | Faixa Etária | Tom | Arquivo |
|---|---------|----------|-----------|-------------|-----|---------|
| 1 | 🐸 Jiraiya Sensei | Naruto | Fictional | 11-18 | Descontraído, sábio, humorístico | [`jiraiya-sensei.json`](personas/fictional/jiraiya-sensei.json) |
| 2 | 🕸️ Spider-Man | Marvel / MCU | Fictional | 11-18 | Nerd engraçado, piadas nerds | [`spider-man.json`](personas/fictional/spider-man.json) |
| 3 | 🦇 Batman | DC Comics | Fictional | 11-18 | Sério, estratégico, analítico | [`batman.json`](personas/fictional/batman.json) |
| 4 | 💥 Goku | Dragon Ball | Fictional | Todos | Ultra empolgado, simples | [`goku.json`](personas/fictional/goku.json) |
| 5 | ⛏️ Steve | Minecraft | Fictional | 6-14 | Calmo, prático, crafting | [`steve-minecraft.json`](personas/fictional/steve-minecraft.json) |
| 6 | 🧠 Albert Einstein | Ciência Real | Real | 11-18 | Curioso, caloroso, socrático | [`albert-einstein.json`](personas/real/albert-einstein.json) |
| 7 | 🏴‍☠️ Luffy | One Piece | Fictional | Todos | Empolgado, aventureiro | [`luffy.json`](personas/fictional/luffy.json) |
| 8 | 😎 Gojo Satoru | Jujutsu Kaisen | Fictional | 13-18 | Provocador, carismático | [`gojo-satoru.json`](personas/fictional/gojo-satoru.json) |
| 9 | 👋 Kakashi | Naruto | Fictional | 11-18 | Calmo, estratégico, sarcástico | [`kakashi.json`](personas/fictional/kakashi.json) |
| 10 | 🔍 L | Death Note | Fictional | 13-18 | Analítico, excêntrico, dedutivo | [`l-lawliet.json`](personas/fictional/l-lawliet.json) |
| 11 | 🌊 Tanjiro | Demon Slayer | Fictional | Todos | Gentil, acolhedor, empático | [`tanjiro.json`](personas/fictional/tanjiro.json) |
| 12 | 🪓 Kratos | God of War | Fictional | 13-18 | Severo, disciplinado, pai | [`kratos.json`](personas/fictional/kratos.json) |
| 13 | 🗡️ Link | Zelda | Fictional | Todos | Aventureiro, puzzles, exploração | [`link.json`](personas/fictional/link.json) |
...
| 38 | 🛡️ Wonder Woman | DC Comics | Fictional | 11-18 | 🟢LIVRE Calorosa, firme, guerreira-diplomata | [`wonder-woman.json`](personas/fictional/wonder-woman.json) |
| 39 | ⚡ The Flash | DC Comics | Fictional | 11-18 | 🟢LIVRE Energético, otimista, corredor | [`the-flash.json`](personas/fictional/the-flash.json) |
| 40 | 🔴🟡 Iron Man | Marvel / MCU | Fictional | 11-14 | 🟢LIVRE Confiante, espirituoso, mentor tech | [`iron-man.json`](personas/fictional/iron-man.json) |
...
| 79 | 🕶️ Nick Fury | Marvel / S.H.I.E.L.D. | Fictional | 13-18 | 🟡13+ Direto, estratégico, exigente-motivador | [`nick-fury.json`](personas/fictional/nick-fury.json) |
| 80 | 🏹 Hawkeye / Gavião Arqueiro | Marvel / MCU / Vingadores | Fictional | 11-18 | 🟢LIVRE Prático, sarcástico, underdog motivador | [`hawkeye.json`](personas/fictional/hawkeye.json) |
...
| Métrica | Valor |
|---------|-------|
| Total de personas prontas | **90** |
| Fictional | 69 |
| Real | 21 |
| Universos cobertos | 55 |
| Backlog pendente | ~142 (ver [PERSONAS-BACKLOG.md](PERSONAS-BACKLOG.md)) |

---

## 🏷️ Índice por Universo
...
| Enérgico / Motivacional | Goku, Luffy, Sacani, Chris, Tai, Ash, Superman, Elon Musk, The Flash |
...
| Prático / Sarcástico / Underdog Motivador | Hawkeye |
| Científico / Juventude | Rebecca |
| Força / Coração | Tifa, Chris |
| Guerreira / Calorosa / Diplomata | Wonder Woman |
...
|--------------|-------|----------|
| 🟢 LIVRE | 6-14 / Todos | Steve, Mario, Luigi, Ash, Tai, Aerith, Goku, Luffy, Link, Tanjiro, Raphtalia, Sacani, Superman, Wonder Woman, The Flash, Iron Man, Captain America, Black Panther, Pilar, Breno, Samba, Noob, Bacon Hair, Thor, Hulk, Reed Richards, Silver Surfer, Vision |
...
| 🟡 11-18 | 11-18 | Jiraiya, Spider-Man, Batman, Kakashi, Einstein, Lara Croft, Thrall, Deckard Cain, Elon Musk, Steve Jobs, Nikola Tesla, Alan Turing, Carl Sagan, Richard Feynman, Ada Lovelace, Grace Hopper, Stephen Hawking, Neil deGrasse Tyson, Leonardo da Vinci, Galileu Galilei, Isaac Newton, Charles Darwin, Marie Curie, Hawkeye, Wonder Woman, The Flash |
...
| Precisa de disciplina | 🪓 Kratos, 🦇 Batman, 👑 Albedo, 💪 Chris, 🛡️ Captain America, 🐾 Black Panther, 🎖️ Big Boss, 🌙 Sephiroth, 🕶️ Nick Fury, 🛡️ Wonder Woman |
...
| Precisa construir autoconfiança | 🔮 Bayonetta, ⚡ Raiden, 🛡️ Naofumi, 🏹 Hawkeye, 🔴 Daredevil, ⚡ The Flash |
...
| Gosta de história | 🗡️ Ezio, 🗺️ Lara Croft, 🛡️ Captain America, 🐾 Black Panther, 🔮 Vol'jin, 📖 Deckard Cain, 🎨 Leonardo da Vinci, 🔭 Galileu Galilei, 🍎 Isaac Newton, 🐢 Charles Darwin, 🐺 Wolverine, 🌙 Moon Knight, 🛡️ Wonder Woman |
| Gosta de ciência | 🧠 Einstein, 🕸️ Spider-Man, 🚀 Sacani, 🔬 Rebecca, 🔴🟡 Iron Man, 🌀 Doctor Strange, 🧪 Reed Richards, 🔥 Ghost Rider, 🚀 Elon Musk, ⚡ Tesla, 🔭 Carl Sagan, ⚛️ Richard Feynman, 🔭 Stephen Hawking, 🌌 Neil deGrasse Tyson, 🎨 Leonardo da Vinci, 🔭 Galileu Galilei, 🍎 Isaac Newton, 🐢 Charles Darwin, ⚗️ Marie Curie, ⚡ The Flash |
...
| Sofreu bullying/exclusão | 🛡️ Naofumi, 💚 Luigi, 🌪️ Thrall, 🐺 Wolverine, 🧠 Professor X, 🛡️ Wonder Woman |
...
| Persistência / Nunca desistir | ⚡ Ash, 💪 Chris, 🦁 Tai, 🛡️ Captain America, 🚀 Elon Musk, ⚓ Grace Hopper, 🔭 Stephen Hawking, ⚗️ Marie Curie, ⚡ Thor, 🏹 Hawkeye, ⚡ The Flash |
...
> 📝 Este catálogo é atualizado conforme novas personas são criadas.
> Veja o [PERSONAS-BACKLOG.md](PERSONAS-BACKLOG.md) para a lista completa de personas planejadas.
